...
Pod::Spec.new do |s|
  s.name             = 'CaamDauIconFont'
  s.version          = '1.2.0'
  s.summary          = 'CaamDau 系列产品：阿里矢量图标管理.'
  s.description      = <<-DESC
  ...
  s.source           = { :git => 'https://github.com/CaamDau/IconFont.git', :tag => s.version }

  s.ios.deployment_target = '9.0'
  s.swift_version = ['4.0', '4.2', '5.0']
  s.source_files = 'IconFont/Classes/*.{swift}'
  s.resource_bundles = {
    'CaamDauIconFont' => ['IconFont/Assets/*.{ttf}']
  }
